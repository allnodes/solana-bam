...
fn github_release_download_url(release_semver: &str) -> String {
    format!("https://github.com/allnodes/solana-bam/releases/download/v{release_semver}/solana-bam-v{release_semver}.tar.gz")
}
...
fn check_for_newer_github_release(
    ...
    while page == 1 || releases.len() == PER_PAGE {
        let url = reqwest::Url::parse_with_params(
            "https://api.github.com/repos/allnodes/solana-bam/releases",
            &[
